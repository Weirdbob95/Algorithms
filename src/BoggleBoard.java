 ...
 * StdRandom.java In.java StdOut.java
 *
...
public class BoggleBoard {
    ...
    /**
     * Initializes a random M-by-N board, according to the frequency of letters
    ...
    /**
     * Initializes a board from the given 2d character array, with 'Q'
     * representing the two-letter sequence "Qu".
     *
    ...
    /**
     * Returns the letter in row i and column j, with 'Q' representing the
     * two-letter sequence "Qu".
     *
     * @param i the row
     * @param j the column
     * @return the letter in row i and column j with 'Q' representing the
     * two-letter sequence "Qu".
     */
